...
> Penjelasan kode program percobaan 1
        ...
        kode program diatas ditujukan untuk mencari nilai apakah termasuk A,B,C,D, atau E. Saya menginput nilai 87 dan yang keluar dalah nilai B , pertahankan prestasi anda
...
//2. Untuk mengecek apkah nilai yang dimasukkan kurang dari 0 atau lebih dari 100
//3. Hasilnya adalah keluar tidak lulus, karena dengan menggunakan || jika kondisi pertama maka akan lanjut ke kondisi kedua, dan jika kondisi kedua salah maka akan melakukan perintah elsse
...
> Penjelasan kode program percobaan 2
    ...
    Kode program diatas ditujukan untuk menghitung gaji bersih yang akan diterima pekerja atau pebisnis setelah terkena pajak. Awalnya saya memasukkan pekerja dengan gaji 100.000. Sementara gaji bersih yang diterima pekerja tersebut adalah 90.000 setelah terkena pajak
...
// Jawaban pertanyaan
   ...
   // 1. Karena tipe dapa integer tidak dapat mengeluarkan output koma
   // 2. Fungsinya ialah mengubah tipe data dari hasil double/float menjadi integer
    //3. Untuk menginput tanpa harus menggunakan huruf sama
    //4. Hasil tetap sama, fungsinya untuk menginput tetapi harus memeperhatikan penggunaan huruf seperti kapital
```
...
```
    ...
    Input jumlah pendapatan perbulan: 1000000
